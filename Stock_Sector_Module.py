...
Note: H/T to Sentdex for the tutorials on Matplotlib for finance, which have been
...
# Dictionary identifying if we prefer a fundamental indicator to be high (H) or low (L)
best ={}
best['EPS'] = 'H'
best['Op_margin'] = 'H'
best['PE_f'] = 'L'
...
# When we parse/extract data from Yahoo! finance, we get weird names for some fundamental indicators;
...
class Sector:
    ...
    # Method to calculate the average, median and best values (with the associated ticker) for a list of fundamental indicators
...
#                        rank[i] = int(rank[i])
    ...
    # Method to identify the stock with the best average rank given a list of fundamental indicators
...
class Stock(Sector):
            ...
            for table in tables:
                for row in table.findAll('tr')[1:]:
                    ...
                    try:
                        ...
                        # We store the fundamental indicators in the proper dictionary
                        ...
                        if keyv in sk_fundamental_ind:
                            ...
                            # Yahoo! finance to the more simple name saved in our sk dictionary 
                    ...
                    # Remove negative price-earnings and price-earnings to book ratios
    ...
    # Method to get the analysts' coverage, and store the values in our "Key_stats" dictionary
    def analysts(self):
        try:
            # We call the Yahoo! finance page presenting the analysts's coverage information for our stock, and store
            ...
            # The different indicators can be found between specific sequences of characters,
            # given in these split1 and split2 variables
    ...
    # Method to calculate the rank of a stock, with respect to the other stocks in the same sector,
    ...
    def get_charts(self, start=(2010, 1, 1), candles_size=10, moving_average=100):
        ...
        # We calculate the open, high, low and close prices within a given period (argument candles_size)
